...
public interface OrderDetailRepository extends JpaRepository<Order_Details, Long> {
    ...
    boolean CheckProductExisted(@Param("productId") Long productId,@Param("orderId") Long orderId);

    String qurUpdateQuantity= "UPDATE \"tana_order_details\" SET \"quantity\"=\"quantity\"+ :quantity WHERE \"order_id\"=:orderId AND \"product_id\"=:productId AND \"status\"=0;";
    @Modifying
    ...
    List<Order_Detail_DTO> GetListByOrderId(@Param("orderId") Long orderId);
